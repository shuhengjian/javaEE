...
public class TsysApp extends BaseDomain{
	...
	private Set tsysModules = new HashSet(0);
	public void setTsysModules(Set<TsysModule> tsysModule){
		this.tsysModules = tsysModule;
	}
	
	public Set<TsysModule> getTsysModules() {
		return tsysModules;
	}
