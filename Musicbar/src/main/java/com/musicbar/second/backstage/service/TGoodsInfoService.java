...
public class TGoodsInfoService {
	...
	public int saveOrUpdate(TGoodsInfo goods,TAttach ac) {
		TGoodsInfo sort = mapper.selectMaxSort();
		int goodsSort = sort.getGoodsSort();
	 ...
	 * @return
	 */
	public int updataStock(TGoodsInfo goods) {
		return mapper.updataStock(goods); 
	};
	/**
	 * 获取上一条记录
	 * @param sort
	 * @return
	 */
	public TGoodsInfo infoBySortbefer(Integer sort) {
		return mapper.infoBySortbefer(sort);
	}
	 /**
     * 获取下一条记录
     * @param sort
     * @return
     */
	public TGoodsInfo infoBySortafter(Integer sort) {
		return mapper.infoBySortafter(sort);
	}
    /**
     * 修改排序号
     * @param sort
     ...
     * @return
     */
	public int updateBySort(TGoodsInfo goods) {
    	return mapper.updateBySort(goods);
    }
	/**
	 * 查询预警商品
	 * @return
	 */
	public List<TGoodsInfo> selectByWarning(){
		return mapper.selectByWarning();
	}
}
