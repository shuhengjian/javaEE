...
public class TGoodsInfoController {
	...
	public ModelAndView open(String goodsId) {
	...
	public String save(HttpServletRequest request,TGoodsInfo goods,@RequestParam("file") MultipartFile file){
		 ...
		 try {
			...
			imgCom.resize(configProperties.getGoodsSize(),configProperties.getGoodsSize(),url);
		} catch (IOException e) {
