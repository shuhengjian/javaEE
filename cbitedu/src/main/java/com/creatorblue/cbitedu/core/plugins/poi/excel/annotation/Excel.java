package com.creatorblue.cbitedu.core.plugins.poi.excel.annotation;
...
public @interface Excel {
	...
	/**
	 * 数字格式,相当于同时设置了exportFormat 和 importFormat
	 */
	public String dataformat() default "-1";
	/**
	 * 导出时，对应数据库的字段 主要是用户区分每个字段， 不能有annocation重名的 导出时的列编码
	 */
	public String code()default "";
	
	/*
	 * 格式：居中(center)，居左(left)，居右(right)
	 */
