...
if(opts.search){
	$("<a class=\"panel-tool-search\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
		searchNow();
	});
}
if(opts.more){
	$("<a class=\"panel-tool-more\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
		more_click();
	});
}
...
var t=$(_231);
return $.extend({},$.parser.parseOptions(_231,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{search:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},{more:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"}]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined)});
};
