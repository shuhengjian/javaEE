package com.creatorblue.cbitedu.core.plugins.poi.excel.entity;
...
public class ExportParams extends ExcelBaseParams {
	...
	public ExportParams(String name,String title, String sheetName) {
		this.title = title;
		this.sheetName = sheetName;
		this.name=name;
	}
	public ExportParams(String name,String title, String sheetName,String secondTitle) {
		this.name=name;
		this.title = title;
		this.sheetName = sheetName;
	 ...
	 */
	private short headerColor = HSSFColor.WHITE.index;
